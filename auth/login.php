    ...
    <header class="bg-white shadow-md border-b border-gray-200">
        <div class="container mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <a href="../index.php" class="bg-header-green bg-header-green-hover text-white px-6 py-2 rounded-md font-semibold transition-colors duration-200 shadow-sm">
                    Home
                </a>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="username" 
                                name="username" 
                                class="w-full px-4 py-3 pl-12 border-2 border-gray-300 rounded-lg input-focus focus:border-green-700 focus:ring-2 focus:ring-green-100 transition-all duration-200" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="password" 
                                name="password" 
                                class="w-full px-4 py-3 pl-12 pr-12 border-2 border-gray-300 rounded-lg input-focus focus:border-green-700 focus:ring-2 focus:ring-green-100 transition-all duration-200" 
